...
const Footer = () => (
  <footer className="w-full bg-black/80 text-yellow-200 py-8 px-4 border-t border-yellow-900/40">
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
      <div>
        <div className="text-xl font-bold text-orange-400 mb-2 tracking-wide">BITS TECHFEST</div>
        <div className="text-sm text-yellow-100 mb-2">Cosmic Intelligence: Where Algorithms Meet the Stars</div>
      ...
      <div>
        <div className="font-semibold text-yellow-400 mb-2">Quick Links</div>
        <ul className="text-sm space-y-1">
          <li><a href="/" className="hover:text-yellow-400">Home</a></li>
          <li><a href="/registration" className="hover:text-yellow-400">Register</a></li>
          <li><a href="/events" className="hover:text-yellow-400">Agenda</a></li>
        </ul>
      </div>
      <div>
        ...
        <div className="flex items-center gap-2 text-sm mb-1">
          ...
          <a href="mailto:bitstechfest@dubai.bits-pilani.ac.in" className="hover:text-yellow-400">bitstechfest@dubai.bits-pilani.ac.in</a>
        </div>
      ...
      <div>
        <div className="font-semibold text-yellow-400 mb-2">Legal</div>
        <ul className="text-sm space-y-1">
          <li><a href="/contactus" className="hover:text-yellow-400">Contact Us</a></li>
        </ul>
      </div>
    </div>
    <div className="border-t border-yellow-900/40 mt-8 pt-4 flex flex-col md:flex-row items-center justify-between text-xs text-yellow-300">
